...
class GenericOfflineSearchStyle {
  ...
  const GenericOfflineSearchStyle({
    this.textStyle,
    this.hintStyle,
    this.decoration,
    this.padding,
  ...
  GenericOfflineSearchStyle mergeWithDefault(BuildContext context) {
    final theme = Theme.of(context);
    return GenericOfflineSearchStyle(
      textStyle:
          textStyle ??
