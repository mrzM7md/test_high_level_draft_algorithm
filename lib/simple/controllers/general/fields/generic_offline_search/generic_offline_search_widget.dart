...
class GenericOfflineSearchWidget<T> extends StatelessWidget {
  ...
  const GenericOfflineSearchWidget({super.key, required this.controller, required this.labelText, this.hintText = "بحث...", required this.itemBuilder, required this.selectedItemLabel, this.showReloadButton = true});
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) => Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              TextField(decoration: const InputDecoration(labelText: "بحث...", prefixIcon: Icon(Icons.search), border: OutlineInputBorder()), onChanged: controller.onSearchQueryChanged, autofocus: true),
                  ...
                  builder: (context, _) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(onTap: () { controller.updateTemp(item); Navigator.pop(sheetContext); }, child: itemBuilder(item, isSelected));
                      },
                    );
                  },
                ),
